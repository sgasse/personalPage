...
from app.news_crawler.secret import auth_key
...
#@mod_landing.route('/cmd', methods=['GET', 'POST'])
#def command_prompt():
#    valid_cmds = {
...
#            return render_template('landing/form.html', msg='Wrong password')
#        else:
#            if request.form['command'] in valid_cmds:
#                valid_cmds[request.form['command']]()
#                return render_template('landing/form.html', msg=f"Ran command {request.form['command']}")
#            else:
#                return render_template('landing/form.html', msg=f"Unknown command '{request.form['command']}'")
#
